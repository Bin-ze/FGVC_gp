...
def get_args():
    ...
    parser.add_argument("--pretrained_path", default="/home/liuguangcan/internship/Fine-Grained-Classification/runs/models/91e2c5a9-35e4-45ee-90e4-c53d85558bbc/FGVC_PIM_autotables-2503-train-1.pth", type=str)

    parser.add_argument("--val_root", 
        default="./datas/CUB_200/test/", type=str)
